...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Image sizes
    # FPN paths upsample a stride-16 map back to stride-8.  For P3-P5
    # variants, rectangular batches padded only to stride 32 can produce
    # odd intermediate dimensions (e.g. 41 -> 42 after upsample).  Use 64
    # as the input/grid alignment for all variants; it is already required
    # by the P6 W6 model and prevents concat shape mismatches at validation.
    gs = max(int(model.stride.max()), 64)  # grid/alignment size
