...
class Model(nn.Module):
    def __init__(self, cfg='yolor-csp-c.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        ...
        if isinstance(m, IAuxDetect):
            s = 256  # 2x min stride
            # Auxiliary heads can contain either P3-P5 or P3-P6.  The old
            # hard-coded [:4] made valid three-scale training configs fail
            # while reshaping anchors (3 anchors vs 4 inferred strides).
